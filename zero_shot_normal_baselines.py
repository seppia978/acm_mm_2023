...
def main(args):
    ...
    for class_to_delete in all_classes:
        ...
        if dataset.lower() == 'imagenet':
            ...
            train.targets = torch.Tensor(_train.targets).long()[id_train].tolist() #torch.Tensor(_val.targets).int()[idx_train].tolist()
            train.real_targets = train.targets
            real_targets = train.targets # sara
            ...
            # TODO: split val in unlearning and retaining
             #torch.Tensor(_val.targets).int()[idx_train].tolist()
            train.num_classes = len(idx_train)
